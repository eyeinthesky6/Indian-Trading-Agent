...
class TradePlanTests(unittest.TestCase):
    def test_valid_long_plan(self):
        plan = build_trade_plan(symbol="RELIANCE", side="long", current_price=100, entry_low=99, entry_high=101, stop=95, targets=[110, 115], capital=100000)
    ...
    def test_bad_stop_rejected_in_packet(self):
        plan = build_trade_plan(symbol="X", side="long", current_price=100, entry_low=99, entry_high=101, stop=100, targets=[110])
